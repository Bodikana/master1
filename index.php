...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Freelancer</b> Portal</span>
    </a>
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
      ...
      <div class="container">
        <div class="column">
		  <div class="col-md-12 text-center index-head">
            <h1>All <strong>Freelancers</strong> In One Place</h1>
            <p>One search, global reach</p>
            <p><a class="btn btn-success btn-lg" href="freelancers.php" role="button">Search Freelancers</a></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="Freelancers" class="content-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Freelancers</h1>
            <p>Finding a job just got easier. Create a profile, get verified and apply for a job with a single mouse click.</p>            
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              ...
              <div class="caption">
                <h3 class="text-center">Apply & Get Verified</h3>
              </div>
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 about-text margin-bottom-20">
            <p>The online Freelancer Vetting application allows job seekers and recruiters to connect.
			The application provides the ability for freelancers to create their accounts, upload their profile and resume, get verified, search for jobs, apply for jobs and view different job openings. 
			The application provides the ability for companies to create their accounts, search  for freelancers, create job postings, and view freelancers applications.
            </p>
            <p>
              This website is used to provide a platform for freelencers to get their dream jobs and excel in their career.
              This site can be used as a paving path for both companies and freelancers for a better life .
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018-2019 <a href="learningfromscratch.online">Web and Vetted</a>.</strong> All rights
    reserved.
    </div>
  </footer>
